<div>{{-- Raíz única requerida por Livewire --}}
    ...
    <style>
        ...
        .dark-mode-active .chip-pending {
            background: #451a03;
            color: #fcd34d;
            border-color: #78350f;
        }

        .dark-mode-active .chip-in_progress {
            background: #1e3a5f;
            color: #93c5fd;
            border-color: #1d4ed8;
        }

        .dark-mode-active .chip-on_hold {
            background: #1f2937;
            color: #9ca3af;
            border-color: #374151;
        }

        .dark-mode-active .chip-testing {
            background: #2e1065;
            color: #c4b5fd;
            border-color: #4c1d95;
        }

        .dark-mode-active .chip-done {
            background: #052e16;
            color: #86efac;
            border-color: #166534;
        }
    ...
    <div class="cal-wrap {{ auth()->user()->settings?->theme === 'dark' ? 'dark-mode-active' : '' }}">
        ...
        <div class="cal-legend">
            ...
            <div class="legend-item">
                <div class="legend-dot" style="background:#f59e0b;"></div> Pendiente
            </div>
            <div class="legend-item">
                <div class="legend-dot" style="background:#3b82f6;"></div> En progreso
            </div>
            <div class="legend-item">
                <div class="legend-dot" style="background:#6b7280;"></div> En pausa
            </div>
            <div class="legend-item">
                <div class="legend-dot" style="background:#8b5cf6;"></div> En pruebas
            </div>
            <div class="legend-item">
                <div class="legend-dot" style="background:#22c55e;"></div> Hecha
            </div>
            <span class="ms-3"
                style="font-weight:700; color:var(--cal-text); font-size:.72rem; margin-right:4px;">Prioridad (barra
                izq.):</span>
            <div class="legend-item">
                <div style="width:3px;height:14px;border-radius:2px;background:#ef4444;"></div> Muy alta
            </div>
            <div class="legend-item">
                <div style="width:3px;height:14px;border-radius:2px;background:#f97316;"></div> Alta
            </div>
            <div class="legend-item">
                <div style="width:3px;height:14px;border-radius:2px;background:#eab308;"></div> Media
            </div>
            <div class="legend-item">
                <div style="width:3px;height:14px;border-radius:2px;background:#60a5fa;"></div> Baja
            </div>
            <div class="legend-item">
                <div style="width:3px;height:14px;border-radius:2px;background:#94a3b8;"></div> Muy baja
            </div>
        </div>
                    ...
                    @foreach ($week as $colIndex => $day)
                        ...
                        @if ($day === null)
                            <div class="{{ implode(' ', $cellClasses) }}"
                                wire:key="empty-{{ $currentYear }}-{{ $currentMonth }}-{{ $weekIndex }}-{{ $colIndex }}">
                            </div>
                        @else
                            <div class="{{ implode(' ', $cellClasses) }}"
