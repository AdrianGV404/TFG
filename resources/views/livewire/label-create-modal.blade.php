            ...
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content shadow-lg border-0">
                    ...
                    <div class="modal-body">
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <input type="text" 
                                       ...
                                       autofocus>
                                @if($editId)
                                    <button class="btn btn-outline-secondary" type="button" wire:click="resetForm" title="Cancelar edición">
                            ...
                            <button type="button" class="btn btn-primary btn-sm w-100 mt-2" wire:click="save" wire:loading.attr="disabled">
                        ...
                        <div>
                            <label class="form-label small text-muted text-uppercase fw-bold mb-2">Etiquetas Existentes</label>
                            <div class="list-group list-group-flush border rounded" style="max-height: 220px; overflow-y: auto;">
                                @forelse($labels as $label)
                                    <div class="list-group-item d-flex justify-content-between align-items-center py-2 px-2" wire:key="label-{{ $label->id }}">
                                        <span class="text-truncate small fw-medium" style="max-width: 65%;">{{ $label->name }}</span>
                                        <div class="btn-group flex-shrink-0">
                                            <button type="button" class="btn btn-sm btn-link text-secondary p-1" wire:click="editLabel({{ $label->id }})" title="Editar">
                    ...
                    <div class="modal-footer bg-light border-0">
                        <button type="button" class="btn btn-secondary btn-sm w-100" wire:click="closeModal">Cerrar</button>
                    </div>
                </div>
            </div>
        </div>
