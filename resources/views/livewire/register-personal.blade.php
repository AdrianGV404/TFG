    ...
    <div class="card p-4 shadow-sm" style="width: 550px;">
        ...
        <form wire:submit.prevent="addUser">
            ...
            <div class="mb-4 p-3 bg-white rounded border">
                <h5 class="text-secondary border-bottom pb-2 mb-3"><i class="fas fa-shield-alt me-1"></i> Asignar
                    Permisos</h5>
                ...
                <div class="form-check">
                    ...
                    <label for="can_create_project_tasks_by_others" class="form-check-label">Puede crear tareas en su
                        proyecto creadas por otros</label>
                </div>
                <div class="form-check mb-3">
                    <input type="checkbox" id="can_create_any_task" wire:model.defer="can_create_any_task"
                        class="form-check-input">
                    <label for="can_create_any_task" class="form-check-label">Puede crear cualquier tarea de la
                        plataforma</label>
                </div>
                ...
                <div class="form-check">
                    ...
                    <label for="can_edit_project_tasks_by_others" class="form-check-label">Puede editar tareas en su
                        proyecto creadas por otros</label>
                </div>
                <div class="form-check mb-3">
                    <input type="checkbox" id="can_edit_any_task" wire:model.defer="can_edit_any_task"
                        class="form-check-input">
                    <label for="can_edit_any_task" class="form-check-label">Puede editar cualquier tarea de la
                        plataforma</label>
                </div>
                ...
                <div class="form-check">
                    ...
                    <label for="can_delete_project_tasks_by_others" class="form-check-label">Puede borrar tareas en su
                        proyecto creadas por otros</label>
                </div>
                <div class="form-check mb-3">
                    <input type="checkbox" id="can_delete_any_task" wire:model.defer="can_delete_any_task"
                        class="form-check-input">
                    <label for="can_delete_any_task" class="form-check-label">Puede borrar cualquier tarea de la
                        plataforma</label>
                </div>
                ...
                <div class="form-check">
                    <input type="checkbox" id="can_reassign_users" wire:model.defer="can_reassign_users"
                        class="form-check-input">
                    <label for="can_reassign_users" class="form-check-label">Puede reasignar usuarios en las
                        tareas</label>
                </div>
            </div>
